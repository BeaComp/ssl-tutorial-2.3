...
main(int argc, char **argv)
{
	...
	printf("Carregou a chave privada.\n");
	...
	while(cleanup != 1)
	{
		...
		//Se eu coloco cliaddr.sin_port aparece --> 35004 (por ex)
		//Se eu coloco assim, com o servaddr, ele retorna o 14550
		//cliaddr serve para o enderço do cliente que se conectou
